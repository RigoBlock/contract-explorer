            ...
            <Grid item xs={4}>
              ...
              <Grid container spacing={8} style={containerGroupWrapperStyle}>
                ...
                <Grid item xs={12}>
                  ...
                  this.state.abi.constructor === Object ? null : (
                    <EventsValues eventsList={this.state.eventsList} />
                  )}
                </Grid>
              </Grid>
            </Grid>
                    ...
                    <Paper style={paperStyle} elevation={2}>
                      <Grid item xs={12}>
                        <EventsFilters
                          ...
                          enableEventTopicField={
                            this.state.enableEventTopicField
                          }
                          disabled={
                            Object.keys(this.state.abi).length === 0 &&
                            this.state.abi.constructor === Object
                          }
                        />
                      </Grid>
                    </Paper>
